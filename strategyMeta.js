 ...
 * strategyMeta.js
 * ---------------------------------------------------------
 * Mapa id -> { name, category } das 15 estratégias, espelhando os
...
const STRATEGY_META = {
  ...
  xadrezInformalRed: { name: 'Xadrez Informal (Vermelho)', category: 'Alternância' },
  xadrezInformalBlack: { name: 'Xadrez Informal (Preto)', category: 'Alternância' },
  nextXadrezRed: { name: 'Next Xadrez (Vermelho)', category: 'Alternância' },
  nextXadrezBlack: { name: 'Next Xadrez (Preto)', category: 'Alternância' },
